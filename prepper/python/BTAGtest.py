...
process.jecSequence = cms.Sequence(process.patJetCorrFactorsDeepCSV * process.updatedPatJetsDeepCSV)# * process.QGTagger)
...
process.out = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('myOutputFile_BTAGonly.root')
)
